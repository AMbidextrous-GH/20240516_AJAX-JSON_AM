...
　そして、誰でも知っているインタアナショナル酒場バアでビールを飲んだ。ここの家はどう云う理由か、エビス・ビールを看板にしているが、私はずっと前に、矢張りその界隈にあるハムブルグ酒場で、大変美味しいピルゼンのビールを飲んだことがあった。
...
// 日本語文字をエスケープせずに表示します。スラッシュ (/) をエスケープせずに表示します。インデントと改行を加えて、見やすく整形します。
